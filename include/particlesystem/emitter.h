...
public:
    // Constructor
    Uniform(glm::vec2 _position, float _size, int _amount, float _angle, float color1, float color2,
            float color3)
        : Emitter(_position, _size, 1, {color1, color2, color3, 1})
        , amount(_amount)
        , angle1(_angle) {
...
public:
    // Constructor
    Snowfall(glm::vec2 _position, float _size, int _amount, float color1, float color2,
             float color3)
